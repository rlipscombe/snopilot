...
/*      values:                                                         */
/*                                                                      */
/*       `t' - test for presence, return TRUE/FALSE in PJ_PARAM_VALUE.i         */
/*       `i' - integer value returned in PJ_PARAM_VALUE.i                       */
/*       `d' - simple valued real input returned in PJ_PARAM_VALUE.f            */
/*       `r' - degrees (DMS translation applied), returned as           */
/*             radians in PJ_PARAM_VALUE.f                                      */
/*       `s' - string returned in PJ_PARAM_VALUE.s                              */
/*       `b' - test for t/T/f/F, return in PJ_PARAM_VALUE.i                     */
/*                                                                      */
/************************************************************************/

	PJ_PARAM_VALUE /* test for presence or get parameter value */
pj_param(paralist *pl, char *opt) {
	int type;
	unsigned l;
	PJ_PARAM_VALUE value;
